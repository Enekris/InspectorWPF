...
{
    public class DocumentsOthersMap : IEntityTypeConfiguration<DocumentsOthersDb>
    {
        public void Configure(EntityTypeBuilder<DocumentsOthersDb> builder)
        {
